...
""" 03_ising2d_analysis | Version: 2020-12-12 """
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 9: Estimación de Tc como el valor máximo muestreado de cada C(T)
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 10: Evolución de beta_c(L). Correr después del bloque anterior
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 11: Fitting de magnetización para T<Tc para estimar exponente beta crítico
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# 12: Fitting de la susceptibilidad para T<Tc para estimar exponente beta crítico
...
# Nota: La referencia en cuestión parece tener muchos errores
